...
export const GEWERK_PREISE: Record<string, PreisVorlage[]> = {
  ...
  entrümpelung: [
    ...
    { category: 'Entrümpelung – Erschwernisse', title: 'Zuschlag kein Aufzug (je Etage ab 1. OG)', unit: 'Etage', hint: '35–55 €', defaultPrice: 45.00 },
    { category: 'Entrümpelung – Erschwernisse', title: 'Zuschlag enge Treppenhäuser / Altbau', unit: 'Pauschale', hint: '65–100 €', defaultPrice: 80.00 },
    { category: 'Entrümpelung – Erschwernisse', title: 'Zuschlag Asbest / Sondermüll vorhanden (Schutzausrüstung)', unit: 'Pauschale', hint: '140–220 €', defaultPrice: 180.00 },
  ...
  reinigung: [
    ...
    // Erschwernisse
    { category: 'Reinigung – Erschwernisse', title: 'Zuschlag Nachtarbeit (22:00–06:00 Uhr)', unit: '%', hint: '25 %', defaultPrice: 25.00 },
    { category: 'Reinigung – Erschwernisse', title: 'Zuschlag Wochenendarbeit (Sa/So)', unit: '%', hint: '25 %', defaultPrice: 25.00 },
    { category: 'Reinigung – Erschwernisse', title: 'Zuschlag stark verschmutzt / vernachlässigt', unit: '%', hint: '50 %', defaultPrice: 50.00 },
    // Stundenleistungen
  ...
  abbruch: [
    ...
    // Erschwernisse
    { category: 'Abbruch – Erschwernisse', title: 'Zuschlag Innenstadtlage / enge Bebauung (Schutzmaßnahmen)', unit: 'Pauschale', hint: '2.800–4.200 €', defaultPrice: 3500.00 },
    { category: 'Abbruch – Erschwernisse', title: 'Zuschlag Stahlbeton (armierter Beton gegenüber Mauerwerk)', unit: '%', hint: '50 %', defaultPrice: 50.00 },
    { category: 'Abbruch – Erschwernisse', title: 'Zuschlag bewohntes Gebäude (laufender Betrieb, eingeschränkt)', unit: 'Pauschale', hint: '355–545 €', defaultPrice: 450.00 },
    // Stundenleistungen
  ...
  maler_fassade: [
    ...
    { category: 'Fassade – Erschwernisse', title: 'Zuschlag Denkmalschutz / besondere Materialauflagen', unit: '%', hint: '30 %', defaultPrice: 30 },
    { category: 'Fassade – Erschwernisse', title: 'Zuschlag Winterarbeiten (Frost unter 5°C, Wetterschutzplane)', unit: 'Pauschale', hint: '380–580 €', defaultPrice: 480 },
