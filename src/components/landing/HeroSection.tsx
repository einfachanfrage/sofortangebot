...
export function HeroSection() {
  return (
    <section className="bg-bg min-h-screen flex flex-col justify-center pt-16">
        ...
        <div className="grid md:grid-cols-[3fr_2fr] gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="font-syne font-extrabold text-anthracite text-[34px] md:text-[50px] lg:text-[58px] leading-[1.08] tracking-tight mb-7 max-w-2xl">
              ...
              <span className="bg-yellow px-2 rounded-xl whitespace-nowrap">Fertig gerechnet</span>, bevor du im Auto sitzt.
            </h1>

            <p className="text-anthracite/55 text-base md:text-lg leading-relaxed mb-10 max-w-lg">
              Sofortangebot ist die Angebots-App für Maler — und sie <span className="text-anthracite font-bold">rechnet, statt zu schätzen</span>: Wandflächen aus Umfang × Höhe, Fenster und Türen abgezogen, jeder Rechenweg zum Nachprüfen. Kurz drüberschauen, als PDF raus, Feierabend.
            </p>

            <Link
              href="/register"
              className="inline-block bg-yellow text-anthracite font-black text-base md:text-lg px-8 py-4 rounded-2xl hover:bg-[#e6b800] active:scale-95 transition-all mb-4 shadow-lg shadow-yellow/30"
            >
              Kostenlos testen →
            </Link>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="w-full max-w-[340px] flex flex-col gap-3">
              ...
              <div className="bg-anthracite rounded-3xl rounded-br-lg px-5 py-4 shadow-xl self-end w-[92%]">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-full bg-yellow flex items-center justify-center shrink-0">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--color-anthracite)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex justify-center items-center gap-2 py-1">
                <span className="text-anthracite/30 text-[12px] font-bold">wird zu</span>
                <span className="text-yellow text-[18px]">↓</span>
              </div>

              {/* Angebots-Karte — wie in der App */}
              <div className="bg-white rounded-3xl p-5 shadow-xl border border-anthracite/5">
                ...
                <div className="flex items-baseline justify-between gap-2 mb-2.5">
                  <span className="text-anthracite/70 text-[13px] font-bold">Deckenfläche streichen</span>
                  <span className="text-anthracite/70 text-[13px] font-extrabold shrink-0">20,00 m²</span>
                </div>
                <div className="flex items-baseline justify-between gap-2 mb-4">
                  <span className="text-anthracite/70 text-[13px] font-bold">Sockelleisten abkleben</span>
