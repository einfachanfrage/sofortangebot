    ...
    <section className="bg-white py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-5 md:px-10">
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3 mb-5">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-syne font-extrabold text-[#2C2C2C] text-[19px] md:text-[21px] tracking-tight">{g.gewerk}</span>
                </div>
              ...
              <ul className="flex flex-col gap-1.5 mb-4">
                {g.positionen.map(p => (
                  <li key={p} className="flex items-center gap-2 text-[#555] text-sm">
                    <span className="text-[#2C2C2C]/20 text-xs">·</span>
                    {p}
                  </li>
                ))}
              </ul>

              <p className="text-[#2C2C2C]/30 text-xs font-semibold">{g.hinweis}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.p
          ...
          className="text-[#888] text-sm mb-12 border-l-2 border-[#F5C400] pl-4"
        >
        ...
        >
          <p className="font-syne font-extrabold text-[#2C2C2C] text-[15px] mb-1">Weitere Gewerke folgen</p>
