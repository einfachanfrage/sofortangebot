    ...
    <section className="bg-yellow py-20 md:py-28">
      <div className="max-w-6xl mx-auto px-5 md:px-10">
        <div className="grid md:grid-cols-[1fr_auto] gap-12 md:gap-16 items-center">
          ...
          >
            <h2 className="font-syne font-extrabold text-anthracite leading-tight tracking-tight mb-6 text-[32px] md:text-[44px] lg:text-[52px]">
              Feierabend statt<br />
              Angebot schreiben.
            </h2>
            <p className="text-anthracite/60 text-base md:text-lg leading-relaxed mb-10 max-w-xl">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-1.5">
              {['Keine Kreditkarte', 'In 5 Minuten eingerichtet', 'Monatlich kündbar'].map(t => (
                <span key={t} className="flex items-center gap-1.5 text-anthracite/50 text-sm font-medium">
                  <span className="text-anthracite/70 font-bold">✓</span> {t}
                </span>
              ))}
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              <div key={step.label}>
                <div className="flex items-center gap-3 bg-white/40 rounded-2xl px-5 py-3.5">
                  <span className="text-xl">{step.icon}</span>
                  <span className="font-syne font-extrabold text-anthracite text-[14px]">{step.label}</span>
                </div>
                {i < 2 && (
                  <div className="flex justify-center py-1">
                    <span className="text-anthracite/30 text-sm">↓</span>
                  </div>
                )}
              </div>
            ))}
