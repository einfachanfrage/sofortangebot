  ...
  return (
    <div>
      <button
        onClick={start}
        disabled={loading}
        className="flex items-center gap-2 bg-yellow text-anthracite font-extrabold text-[14px] px-5 py-3 rounded-2xl active:translate-y-px transition-transform disabled:opacity-60 shadow-sm shadow-yellow/30"
      >
        {loading
