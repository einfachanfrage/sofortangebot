    ...
    <>
      {variant === 'primary' ? (
        <button
          ...
          className="w-full bg-yellow hover:bg-yellow-600 active:bg-yellow-700 text-anthracite font-black rounded-2xl py-3 text-sm active:translate-y-px transition-all"
        >
          + Neue Baustelle
        </button>
      ) : (
