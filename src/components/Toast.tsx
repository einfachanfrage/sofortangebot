...
export function Toast({ message }: { message: string }) {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-8 left-1/2 -translate-x-1/2 z-50 bg-[#2C2C2C] text-white font-extrabold text-sm px-5 py-3 rounded-full shadow-xl whitespace-nowrap">
      {message}
    </div>
  )
}
