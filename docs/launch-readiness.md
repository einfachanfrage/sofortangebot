...
|---|---|---|
| **Gate 1** — erste Testnutzer | **≈ 50,3 %** (14.09., 14:53: nach der Auflösung von CoS-P-014, 2.365 ÷ 47 — drei Blöcke direkt unter dieser Tabelle) | 47 |
...
| 5.3 | Funktioniert auf Handy UND Desktop | G1 | 🔴 25 % — **13.09. erstmals erhoben, 0 → 25 %** — in Desktop- und Handy-Breite getestet, zwei gerätespezifische Befunde gefixt (DC-062, DC-072). Kein echtes Gerät, kein systematischer Durchgang. Vorheriger Stand: 0 %, nicht erhoben. |
