...
## Gate-Fortschritt (Stand 05.09.2026, echte Neuberechnung)

| Gate | Fortschritt | Punkte |
|---|---|---|
| **Gate 1** — erste Testnutzer | **≈ 54,2 %** (17.09. abends: Fallbasis 97/100 und E-Rechnungs-Empfang bewertet, 2.547 ÷ 47) | 47 |
...
> ### 🔄 Neuberechnung 17.09.2026, Abend (Chief of Staff) — Gate 1 von 53,0 % auf **54,2 %**
>
> | Punkt | vorher | jetzt | Δ |
> |---|---|---|---|
> | 1.1 Kernrechnungen ueber breite Fallbasis | 64 | **78** | +14 |
> | 4.7 Eigene Buchhaltung empfaengt E-Rechnungen | 0 | **40** | +40 |
>
> Summe 2.493 → **2.547**, ÷ 47 = **54,19 %**.
>
> **Die unbequeme Zahl dahinter:** Die Fallbasis ist an einem Tag von 78 auf
> **97 von 100** gewachsen, dutzende Funde wurden gebaut und belegt — und Gate 1
> bewegt sich dadurch um **1,2 Punkte**. Das ist kein Rechenfehler, sondern die
> Bauart des Gates: 1.1 ist **einer von 47** gleich gewichteten Punkten. Die
> tiefste Facharbeit des Projekts kann die Zahl gar nicht stark bewegen.
>
> **Was sie bewegt, sind die leeren Felder.** Elf G1-Punkte stehen weiterhin auf
> 0 oder nahe 0: 2.4, 2.7, 4.1, 6.6, 7.13, 9.1, 11.4, 11.5 und die vier
> Tag-X-Punkte 13.1 bis 13.4. Zusammen sind das **rund 1.100 der 2.153 fehlenden
> Punkte**. Sie sind seit gestern verteilt und teilweise in Arbeit.
>
> **Bewusst nicht mitgerechnet:**
> - **11.4 bleibt in Gate 1 und bleibt bei 0.** Finance schlaegt vor, den Punkt
>   nach Gate 2 zu schieben (keine gesetzliche Pflicht fuer ein
>   Einzelunternehmen, Ausloeser ist der erste zahlende Kunde). Die Begruendung
>   ueberzeugt mich — **aber einen Punkt aus dem Gate zu nehmen hebt die Zahl,
>   ohne dass jemand gearbeitet hat.** Das entscheidet Sandy, nicht ich.
> - **9.1 bleibt bei 0**, obwohl ein guter Entwurf existiert. Er ist nicht live,
>   und er enthaelt vier offene Stopper.
> - **2.1 bleibt bei 45.** Manfreds Session 3 fehlt weiterhin.

> ### 🔄 Neuberechnung 16.09.2026 (Chief of Staff) — Gate 1 von 50,3 % auf **53,0 %**
>
> **Auslöser: zwei Live-Durchläufe von Sandy an einem Vormittag.** Kein Deploy,
> kein neuer Code — nur Beweise für Code, der seit dem 14.09. da war.
>
> | Punkt | vorher | jetzt | Δ |
> |---|---|---|---|
> | 2.3 Passwort-Zurücksetzen | 15 | **98** | +83 |
> | 3.1 Pflicht-Mails werden versendet | 35 | **70** | +35 |
> | 5.3 Funktioniert auf Handy und Desktop | 25 | **35** | +10 |
>
> Summe 2.365 → **2.493**, ÷ 47 = **53,04 %**.
>
> **Warum das die gesunde Art von Bewegung ist:** 2.3 und 3.1 standen tief,
> weil ein Live-Test sie am 13.09. **widerlegt** hatte — nicht, weil nichts
> gebaut war. Was fehlte, war der Beweis. 2,7 Punkte an einem Vormittag sind
> hier also kein Ausreißer, sondern die Auflösung einer Schuld.
>
> **Was ausdrücklich NICHT mitbewegt wurde:**
> - **2.1 Registrierung/Login/Logout bleibt bei 45.** Eine Registrierung von
>   null ist etwas anderes als ein Login. Das ist Manfreds Session 3.
> - **3.1 ist gelb, nicht grün.** Die Willkommens-Mail hat niemand ankommen
>   sehen.
> - **1.1 bleibt bei 64**, obwohl die Fallbasis stark gewachsen ist. Eine
>   breitere Fallbasis mit offenen Geld-Funden ist kein höherer Wert — sie ist
>   derselbe Wert mit besserer Sicht. Der Punkt bewegt sich, wenn die Funde
>   behoben sind, nicht wenn sie gefunden werden.
>
> **CoS-P-013 ist damit geschlossen** — der Befund vom 13.09., der drei Tage
> lang die größte offene Baustelle war.

> ### 🔁 Neuberechnung 13.09.2026 (Chief of Staff) — Gate 1 von 49,3 % auf **51,0 %**
>
> **Anlass:** Sandy hat eine Neuberechnung angefordert. Die 49,3 % waren der
> Stand vom 10.09. und enthielten die Testnutzer-Welle vom 11.–13.09. nicht —
> 131 Befunde von Manfred (`docs/testnutzer-notizen-manfred.md`), davon rund
> 25 abgearbeitet. Alle 47 G1-Punkte neu gegen ihre Heimat-Dateien gelesen,
> **neun bewegt, acht davon nach oben, einer nach unten.** Summe 2.315 → 2.397,
> geteilt durch 47 = **51,0 %**.
>
> **Korrektur am selben Abend:** 8.7 stand in der ersten Fassung dieses Blocks
> auf 55 % (Gate 1: 50,8 %). Sandy hat die Statusmeldung von Anthropic
> beigebracht — der Ausfall ist ein Windows-Update-Problem von Claude Cowork,
> kein Projektfehler, und **ihr eigenes Terminal läuft normal**. Die Kette ist
> damit manuell statt unterbrochen; 8.7 steht jetzt auf 65 %. Die erste Zahl
> hatte den Ausfall breiter angenommen, als er ist.
>
> | Punkt | alt | neu | Δ | warum |
> |---|---|---|---|---|
> | 1.1 Fallbasis / Kernrechnungen | 58 | **64** | +6 | CoS-E-038/039/041/050/051: vier echte Geld-Bugs, alle in dieselbe Richtung (der Betrieb rechnet zu billig ab). 1.942 Tests grün. Deckel bleibt: 37 + 7 von ~100 Fällen, PM-032 offen, ein roter Test unbestätigt |
> | 1.2 Abdeckung / Sonderfälle | 80 | **82** | +2 | Raumzuordnung, Termin, Kundenname erledigt — **aber Manfreds Kernbefund steht**: die Pipeline erfindet und vergisst Positionen, und die Rückfragen fragen das Falsche. Bewusst nur +2 |
> | 1.4 Golden Tests | 95 | **96** | +1 | +190 Tests; `vitest.config.ts` sucht nur noch unter `src/` (zwei Fremddateien machten die Suite falsch-rot) |
> | 1.6 Standardpreise | 88 | **93** | +5 | `katalog-standard.ts`: der Standard ist eine benannte, sichtbare Entscheidung statt „kürzester Titel gewinnt". Staffel-Sperrklinke auf 0 |
> | 2.8 Erster Eindruck | 30 | **45** | +15 | DC-052/053/054/062/063 (Commit `acbdc83`) |
> | 5.1 Keine Sackgassen | 0 | **35** | +35 | erstmals erhoben — durch Manfreds Durchlauf, nicht durch eine eigene Runde. DC-063/096, CoS-E-028. DC-099 offen |
> | 5.2 Buttons / nichts kaputt | 74 | **82** | +8 | DC-058/066/071/072/073/079/084, CoS-E-021/024 |
> | 5.3 Handy und Desktop | 0 | **25** | +25 | erstmals erhoben: in beiden Breiten getestet, zwei gerätespezifische Befunde gefixt. Kein echtes Gerät, kein systematischer Durchgang |
> | **8.7 Kette Fix → Deploy → live** | 80 | **65** | **−15** | ⬇️ **Rückstufung, kein Projektfehler.** Windows-Update vom 08.09. hat Claude Cowork den Laufwerkszugriff genommen (`status.claude.com`, Microsoft-Fix ausstehend). Sandys eigenes Terminal läuft — die Kette ist **manuell, nicht unterbrochen**. Abgewertet wird, was real fehlt: ein Mensch als Relaisstelle, und die Designer-Arbeit vom 13.09. liegt uncommittet |
>
> **Was die Zahl erzählt, und warum sie nicht stärker steigt:** Zwei Tage sehr
> hoher Output haben Gate 1 um **1,5 Punkte** bewegt. Das ist kein Rechenfehler
> und keine Untertreibung, sondern hat drei Gründe, die zusammen die eigentliche
> Lage beschreiben:
>
> 1. **Viel Arbeit floss in Punkte, die schon hoch standen** (1.4 bei 95, 1.6 bei
>    88). Von 88 auf 93 sind fünf Punkte, egal wie groß der Umbau war.
> 2. **Der Punkt, der Gate 1 wirklich entscheidet, ist kaum bewegt.** 1.2 steht
>    bei 82, weil Manfreds Kernsatz unverändert gilt: *„Der Kern — Diktat rein,
>    Angebot raus — darf nichts erfinden, was ich nicht gesagt hab, und nichts
>    weglassen, was ich gesagt hab. Solange das nicht stimmt, lese ich jede
>    Zeile."* Genau daran hängt Sandys eigene Messlatte („schneller zu
>    korrigieren als von null zu tippen"), nicht an der Zahl hier.
> 3. **Ein externer Ausfall hat gegengerechnet.** Ohne die Rückstufung von 8.7
>    stünde Gate 1 bei 51,3 %. Der Cowork-Ausfall kostet damit real 0,3
>    Prozentpunkte — und verlangsamt daneben die Verifizierung von allem
>    anderen, weil jeder Testlauf und jeder Commit über Sandys Hände läuft.
>
> **Nicht mitgezählt, bewusst:** DC-100 (die ZUGFeRD-XML im Angebots-PDF
> deklariert sich als Rechnung, im Risikoregister LR-15) ist am 13.09. von Sandy
> entschieden — abschalten — aber noch nicht umgesetzt. Der Punkt hat heute
> keine eigene Zeile in dieser Liste; er gehört fachlich zu 4.7/7.x und wird bei
> der nächsten Vollständigkeitsrunde als eigener Punkt aufgenommen. Das
> verändert dann den Nenner, wie schon am 05.09. — ein ehrlicherer Nenner ist
> besser als ein schmeichelnder.
>
> **Der schnellste Weg nach oben, in dieser Reihenfolge:** die offenen Stände
> von Sandy committen und deployen lassen (8.7 auf ~80 = +0,3 — auf den
> Microsoft-Fix zu warten ist dagegen kein Plan, er ist nicht terminiert),
> Sandys Live-Postfach-Test (2.2/2.3/3.1/3.2 stehen seit
> Wochen bei 55–60 % **nur** deshalb; alle vier auf 90 % = +2,8), dann die
> Fallbasis Richtung 100 Fälle (1.1) und Manfreds Kernbefund (1.2). Das sind
> zusammen rund 6 Prozentpunkte, und zwei davon kosten einen Nachmittag.

> ### 🧪 Nachtrag am selben Abend: Sandys Live-Postfach-Test — Gate 1 von 51,0 % auf **50,2 %**
>
> **Die Vorhersage im Block darüber war falsch, und zwar in die richtige
> Richtung.** Dort stand, der Postfach-Test bringe rund +2,8 Prozentpunkte,
> weil 2.2/2.3/3.1/3.2 „seit Wochen **nur** deshalb" niedrig stünden. Die
> Annahme dahinter war, die Fixe vom 25.08. seien fertig und bräuchten nur
> noch eine Bestätigung. Sandy hat den Durchlauf am 13.09. um 20:21 MESZ
> gemacht — **sie trugen nicht.** Summe 2.397 → 2.360, **−0,8 statt +2,8.**
>
> | Punkt | alt | neu | Δ | warum |
> |---|---|---|---|---|
> | 2.2 Verifizierungs-Mail zugestellt | 55 | **90** | +35 | kam sofort, Posteingang, Absender korrekt, Konto bestätigt |
> | 3.2 Absender/Inhalt/kein Spam | 55 | **70** | +15 | alles gut außer „Links funktionieren" |
> | 2.1 Registrierung/Login/Logout | 62 | **45** | −17 | Login/Logout erstmals belegt, **Registrierung endet auf einer Fehlerseite** |
> | 3.1 Pflicht-Mails werden versendet | 60 | **35** | −25 | eine von drei; Willkommens-Mail wird nie ausgelöst |
> | 2.3 Passwort-Reset funktioniert | 60 | **15** | −45 | live widerlegt, zwei unabhängige Fehler |
>
> **Der teure Fund war nicht der gesuchte.** Gesucht war die Reset-Mail.
> Gefunden wurde zusätzlich, dass `auth/callback/route.ts` ausschließlich
> `?code=` verarbeitet, die Links aus `admin.generateLink()` aber im
> impliziten Ablauf mit `#access_token=…` zurückkommen (Supabase-Auth-Log,
> 18:22:54 UTC: `"login_method":"implicit"`). Der Callback kann für diese
> Links **strukturell nie** gelingen. Daran hängen drei Dinge: jeder neue
> Nutzer sieht eine Fehlerseite, die Willkommens-Mail wird nie ausgelöst,
> und die Tokens landen in der Browser-Adresszeile (gehört zu 6.2). Voller
> Bericht mit allen Log-Belegen: **CoS-P-013** in
> `docs/chief-of-staff-platform-todos.md`.
>
> **Warum das trotz der gefallenen Zahl ein guter Abend war:** Diese beiden
> Fehler hätte der erste echte Testnutzer im Dezember gefunden, beim
> allerersten Klick, und wir hätten bis dahin geglaubt, der Punkt sei
> erledigt. CoS-P-003 hatte den Callback am 24.08. per Code-Review
> ausdrücklich als „sauber" bewertet. Was gefehlt hat, war nicht Sorgfalt,
> sondern ein echter Klick.
>
> **Lektion für diese Datei, bitte künftig anwenden:** „Fix umgesetzt, Live-
> Test steht aus" ist kein hoher Prozentwert, der auf Bestätigung wartet —
> es ist eine **unbestätigte Behauptung**. Die Punkte 2.2/2.3/3.1/3.2 standen
> sechs Wochen lang auf 55–60 %, obwohl zwei von ihnen faktisch bei 15–35 %
> lagen. Nicht nachgetestete Fixe gehören künftig niedriger bewertet, nicht
> höher.

> ### 🚨 14.09.2026 — CoS-P-014: seit dem Vorabend ist nichts mehr live. Gate 1 von 50,2 % auf **49,6 %**
>
> Sandy hat den Postfach-Test heute wiederholt (`+test02`, 14:31 MESZ) —
> **diesmal kam gar keine Mail.** Beim Nachsehen kam etwas anderes heraus, und
> es ist größer: Der letzte erfolgreiche Produktions-Deploy ist vom **13.09.
> um 19:46 UTC**. Die **acht** Deploys danach stehen auf `state: ERROR`, weil
> `src/lib/versandbereit.ts` auf Sandys Rechner liegt, aber nie committet
> wurde. Jeder Build scheitert an `Module not found`.
>
> **Damit ist weder die Designer-Arbeit vom 13.09. live, noch der
> CoS-P-013-Fix vom 14.09.** Sandy hat heute gegen den Stand von gestern
> Abend getestet. Voller Bericht: **CoS-P-014** in
> `docs/chief-of-staff-platform-todos.md`. Der Fix ist ein `git add`.
>
> | Punkt | alt | neu | Δ |
> |---|---|---|---|
> | 8.7 Kette Fix → Deploy → live | 65 | **35** | −30 |
> | 8.4 Fehler-Monitoring | 20 | **15** | −5 (zählt auf Gate 2, nicht auf Gate 1) |
>
> **Zwei Korrekturen an mir selbst, beide am selben Punkt:** Ich habe 8.7
> gestern erst auf 55 gesenkt, dann auf 65 hochkorrigiert mit der Begründung,
> die Kette sei „manuell, nicht unterbrochen". Sie war zu diesem Zeitpunkt
> bereits seit zwei Stunden unterbrochen. Der Fehler war nicht die Zahl,
> sondern dass ich über den Zustand der Kette geurteilt habe, **ohne die
> Deploy-Liste anzusehen** — bei einem Punkt, der genau davon handelt.
>
> **Die Lehre, eine Ebene über allen bisherigen:** Siebzehn Stunden lang sind
> acht Produktions-Deploys fehlgeschlagen, und niemand hat es gemerkt —
> bemerkt wurde es nur, weil zufällig eine Mail ausblieb. **Committet ist
> nicht live.** Solange ein fehlgeschlagener Deploy nirgends aufschlägt, wo
> ein Mensch ihn sieht, ist jede Aussage „ist umgesetzt" in dieser Datei
> ungedeckt. Die Benachrichtigung ist eine Einstellung, kein Bau, und gehört
> zu den ersten Dingen nach dem Fix.
>
> **✅ Aufgelöst am selben Tag, 14:53 MESZ.** Sandy hat in drei Schritten
> nachgezogen: 40 fehlende Dateien erfasst (Commit `90f0fcb`), dann zwei
> Typfehler, die dadurch erst sichtbar wurden (`775715b` — ein fehlendes Feld
> in der PDF-Health-Attrappe und zwei Imports im Preis-Matcher, die auf `.ts`
> endeten). Deploy `dpl_ADRqsU5Q…` steht auf **READY**. 8.7 damit 35 → 70 %,
> Gate 1 **50,3 %**.
>
> **Der Nebengewinn ist größer als die Prozentzahl:** Das Repository enthält
> zum ersten Mal alles — 13 Produktivdateien, 21 Tests und 3 Migrationen, die
> es bis heute nur auf einem einzigen Rechner gab. Wäre dieser Rechner
> ausgefallen, wäre die gesamte Manfred-Welle weg gewesen. Der zweite
> Typfehler zeigt zudem, warum „alle Tests grün" hier nie genügt hat: Die
> `.ts`-Endung in zwei Imports des **Preis-Matchers** — also im Herzstück der
> Preisfindung — hat die Testumgebung toleriert und der Typprüfer nicht.
>
> **Offen bleibt der Teil, der die Wiederholung verhindert:** Deploy-
> Fehlschläge erreichen weiterhin niemanden, und neue Dateien werden weiterhin
> nur erfasst, wenn jemand daran denkt. Beides liegt als Auftrag bei Platform
> (CoS-P-014). Vor diesem Hintergrund steht 8.7 bei 70 und nicht bei 80.
...
> Rückfrage, ob PM-030 ein echter Datenverlust oder nur eine erwartbare
> Zwei-Stufen-Differenz war, hat Head of Product Engineering nachgemessen
> statt geschätzt: **echter Fall eins** — „Sockelleisten abkleben" hing im
> Dachgeschoss-Zweig an einer Größe aus dem falschen Zweig und fiel bei
> Dachgeschossräumen komplett raus, 13,60 € ohne Spur. Root-Cause behoben,
> neuer Test verhindert ein stilles Wiederauftreten. Dabei ist ihm zusätzlich
> aufgefallen, dass Diagonalverlegung seit PM-013 den Verschnitt erhöhte,
> aber auf keinen Preis wirkte, obwohl der Katalog längst eigene Preiszeilen
> dafür hat — jetzt korrekt bepreist und gegen eine naheliegende
> Verwechslungsgefahr (Parkett- vs. Fliesen-Zuschlag) abgesichert. Beide
> Fixes bewegen 1.1 von 54 auf 58 %, Gate 1 von 49,1 auf 49,2 %. Zwei Dinge
> bewusst nicht schöngeredet: für Diagonalverlegung gibt es weiterhin keinen
> einzigen Testfall, und der Live-Nachtest-Rückstand ist mit acht offenen
> Punkten (PM-030, 011, 012, 013, 021, 022, 025, 026) auf einen Blick spürbar
> geworden — beides in der Zeile bei 1.1 im Detail vermerkt, nicht nur hier.

> ✅ **Echte Neuberechnung, 05.09.2026 (Chief of Staff) — auf Sandys Wunsch
> „schau dir alles an und aktualisier komplettes Dashboard inkl. Prozent".**
> Vier parallele Fachbereichs-Recherchen (QA/Prüfmeister, Engineering/
> Platform, Legal, Finance/Marketing/GTM) plus eigene volle Prüfung dieser
> Datei liegen zugrunde. Alle 95 gezählten Punkte einzeln gegen die aktuellen
> Heimat-Dateien geprüft, keine Delta-Schätzung. **Größte Bewegungen:** 1.1
> Fallbasis (42→54 %) — CoS-043 (VOB-010, 14 Zuschlagspositionen auf echten
> Prozentaufschlag) vollständig umgesetzt und getestet, dabei ein echter
> Geld-Bug im Preis-Matching gefunden UND gefixt (Elektro-Angebot wurde
> mit 25 % statt 50 % Zuschlag berechnet); Prüfmeister-Fallbasis von 28 auf
> 37 Testfälle gewachsen, mehrere weitere echte Bugs gefunden+gefixt, ein
> genuiner Bug (PM-032, ~25 % Fehlerrate) bleibt offen. 1.2 (76→80 %), 1.4
> (92→95 %, erstmals wieder eine harte Testzahl: 1.352–1.468 Tests grün),
> 1.6 (78→85 %), 5.2 (70→74 %) — Details in den Zeilen selbst.
>
> **Zwei Korrekturen, keine neuen Fortschritte:** **11.3 Gewerbeanmeldung**
> stand fälschlich auf „✅ erledigt" — im Widerspruch zu 11.1 und zu drei
> unabhängigen Legal-Quellen, die übereinstimmend „Woche vom 05.10./KW 41,
> noch offen" nennen. Korrigiert auf offen. **9.7** nannte „Token-Aufräumung
> DC-006 in Arbeit" — DC-006 ist laut `design-check.md` bereits seit
> 02.09. fertig (Commit `3e2c778`); Text korrigiert, Prozentzahl leicht
> angehoben (40→48 %), weil die übrigen CI-Punkte (Farbe/Typografie/Icons/
> Logomark) tatsächlich noch offen sind.
>
> **Governance-Hinweis:** `legal-002-risikobewertung-vob.md` (Legals eigene
> Heimat-Datei) verzeichnet LR-14 und LR-09 weiterhin als offen (🔴/🟡),
> obwohl beide laut Engineering-Ticket (CoS-042/CoS-043) inhaltlich
> geschlossen sind — die Schließung fehlt in der Risikobewertung selbst.
> An Head of Legal geflaggt, nicht selbst durchkorrigiert (fremde
> Heimat-Datei).
>
> **Rechnerischer Befund, wichtig für die Zahlen-Ehrlichkeit dieser Datei:**
> Gate 2 war zuletzt mit ≈16,2 % ausgewiesen — eine frische Summierung aller
> 37 aktuellen Zeilenwerte ergibt aber bereits vor den heutigen Bewegungen
> ≈18,8 % (695÷37). Der Unterschied ist reine Rechenweg-Drift: mehrere
> vorangegangene Updates haben Δ-Werte auf die zuletzt gerundete Prozentzahl
> aufaddiert statt die Summe aller 37 Punkte neu zu bilden, was sich über
> mehrere Zyklen aufsummiert hat — keine verschwundenen Daten, keine
> Fehlbewertung einzelner Punkte, nur ein akkumulierter Rundungs-/
> Näherungsfehler in der Kopfzahl. Mit der heutigen realen Bewegung bei 9.7
> (+8 Punkte) ergibt sich ≈19,0 % (703÷37). Gate 1 zeigt diese Drift nicht
> (48,5 %-Basis bereits als echte Summe nachvollzogen, 03.09. korrekt
> neu gerechnet) — Gate 3 ebenfalls nicht (17 %→16,8 %, reine Rundung).
> **Lehre:** künftige Δ-Updates sollten die Summe mitführen, nicht nur die
> gerundete Prozentzahl, um diese Drift nicht erneut entstehen zu lassen.
...
| # | Punkt | Gate | Status |
|---|---|---|---|
| 1.1 | Kernrechnungen tragen über breite Fallbasis (Richtwert ~100 statt 14) | G1 | 🟡 78 % — **17.09. neu berechnet, 64 → 78 %.** Der Deckel, der diesen Punkt seit Wochen gehalten hat, ist weg: die Fallbasis steht bei **97 von 100** (am 14.09. waren es 44). Testlage gemessen: **190 Testdateien, 2.954 Zusicherungen, 2.850 gruen, 0 rot.** Nicht hoeher, weil **104 Sperrklinken offen** sind — bekannte, belegte Funde, die bewusst als offen gefuehrt werden, darunter mehrere, die Geld bewegen. Gefunden ist nicht behoben. Der Punkt geht Richtung 90, wenn die Sperrklinken abgebaut sind, nicht wenn neue Faelle dazukommen. Vorheriger Stand: 🟡 64 % — **13.09. neu berechnet, 58 → 64 %** (Manfred-Welle: CoS-E-038/039/041/050/051, 1.942 Tests grün; Deckel bleibt die Fallbasis 37 + 7 von ~100 und ein unbestätigter roter Test — Begründung im Block „Neuberechnung 13.09.2026" oben). Vorheriger Stand: 🔴 58 % — **02.09.: alle 28 Testfälle haben jetzt eine eindeutige Soll-Lösung** (vorher 21), Prüfmeister hat dabei aber einen neuen, echten, systematischen Rechenfehler gefunden: **VOB-013** — Fensterlaibung wurde ca. 33 % zu groß berechnet, Fensterbank zusätzlich doppelt gezählt, betraf jedes Angebot mit Fenstern/Türen. **03.09.: Code gefixt** (Commit `330743f`, 8 eigene Tests, per Hand nachgerechnet — stimmt), Live-Nachtest durch Prüfmeister steht noch aus, deshalb noch nicht als voll verifiziert gezählt (Prozentzahl unverändert, bis das steht). Breite (28 von ~100) bleibt der limitierende Faktor. **04.09.: Normtext (VOB-011) ausgewertet, vier weitere Funde** — VOB-003 (toter Backlog-Punkt), **VOB-008 (Verdacht LR-14, Score 12)**, VOB-012 (Türbreiten-Abzug), Leibungsposition nur bei Beschichtung — alle vier als CoS-042 an Head of Product Engineering geroutet. **Noch am selben Tag umgesetzt und getestet (1.306 Tests grün, `tsc`/eslint sauber):** VOB-003 gestrichen; **VOB-008 geprüft — Entwarnung, kein Fund:** `boden.ts` ruft die Malerschwelle nirgends auf, zieht überhaupt keine Öffnungen ab — **LR-14 kann geschlossen werden, ohne dass eine Zahl korrigiert werden musste**; VOB-012 gefixt (ändert zehn dokumentierte Soll-Werte um +0,90 lfdm je Standardtür, mit Normverweis nachgezogen); Leibungsposition übersprungen nur bei eindeutig fehlender Beschichtung. Live-Nachtest durch Prüfmeister steht noch aus (wie bei VOB-013), deshalb Prozentzahl weiterhin unverändert bis dahin. **Neu, 04.09.: VOB-010/LR-09** (14 Zuschlagspositionen mit Prozent im Titel, Pauschale im Preis) — Sandy hat „echter Prozentaufschlag" entschieden, Ticket CoS-043 an Head of Product Engineering, noch offen. **05.09.: CoS-043 ebenfalls noch am 04.09. vollständig umgesetzt und getestet.** Die 14 Positionen sind auf echten Prozentaufschlag umgestellt — 9 zeitbezogene Positionen (Wochenend-/Feiertags-/Notdienstzuschläge) gegen das gesamte Angebot, 5 objektbezogene (Denkmalschutz ×3, Sondermaße, exotische Holzart) gegen das jeweilige Gewerk, beides Sandys eigene Entscheidungen vom 04.09.; DB-Migration `cos043_zeitzuschlaege_text` angewendet. **Dabei ein echter, bisher unbemerkter Geld-Bug gefunden und gefixt:** sieben Katalogeinträge hießen alle identisch „Zuschlag Wochenend-/Feiertagsarbeit" (nur der Prozentsatz unterschied sie) — der Preis-Matcher wählte deshalb immer den ersten Treffer, nicht den passenden. Ein echtes Elektro-Angebot wurde dadurch mit 25 % statt korrekt 50 % berechnet, unbemerkt zulasten des Geschäfts. Matcher berücksichtigt jetzt den Prozentsatz im Titel. Testsuite bei diesem Stand: 84 Dateien / 1.352 Tests grün, `tsc`/eslint sauber. **Parallel, Prüfmeister-Seite (Stand 04./05.09.):** Fallbasis von 28 auf **37 Testfälle** gewachsen (näher an ~100, bleibt der limitierende Faktor), dabei mehrere weitere echte Bugs gefunden UND gefixt — Komma-Trennung in `satz-raum.ts`, mehrere bekannte Whisper-Verhörer wie „Zockelleisten"/„Frischgrät"/„Klickvenü"/„Fertigpaket" (neue Infrastruktur `hoerfehler.ts`, korrigiert direkt nach der Transkription, Original bleibt in `entwurf_aufnahmen.transkript_original` erhalten, rückwirkend gegen alle 90 Produktions-Aufnahmen 22.07.–05.09. simuliert), eine falsche Umfangs-Schätzung, eine PM-018-Regression (Q2/Q3), ein PM-010-Kartenzähler-Bug. VOB-012 ist jetzt für 9 von 17 betroffenen Fällen live bestätigt, die restlichen 8 stehen noch aus. Der VOB-013-Live-Nachtest (3 Fenster à 1,20×1,00 m, 25 cm tief → muss 2,40 m² ergeben) ist weiterhin nicht gesprochen worden, trotz eines dafür eigens angelegten neuen Testfalls PM-037 (2-Fenster-Variante). **Ein echter, weiterhin offener Bug: PM-032** — „Belagbezeichnung streut" bei ca. 25 % der gemessenen Fälle, ein Fix ist vorgeschlagen, aber noch nicht gebaut; zählt als genuiner Qualitätsmangel, nicht als erledigt. **Governance-Hinweis (Chief of Staff, 05.09.):** `docs/legal-002-risikobewertung-vob.md` — Legals eigene Heimat-Datei für die Risikobewertung — verzeichnet LR-14 weiterhin als 🔴 Score 12 und LR-09 weiterhin als 🟡 Score 9, obwohl beide laut `chief-of-staff-todos.md` (CoS-042/CoS-043) inhaltlich geschlossen sind. Die Schließung ist damit nur in Engineerings Ticket dokumentiert, nicht in der Risikobewertung selbst — nach „eine Wahrheit pro Sache" eine Lücke, die in die Heimat-Datei gehört, hiermit an Head of Legal geflaggt statt selbst durchkorrigiert. **06.09.: zwei weitere, echte Funde aus dem PM-030-Nachgang, beide gefixt und
mit Regressionstest abgesichert.** (1) **Echter Datenverlust gefunden UND
gefixt:** „Sockelleisten abkleben" hing im Dachgeschoss-Zweig an
`wandflaecheNettoM2 !== null` — einer Größe, die nur der Normal-Zweig füllt;
bei Dachgeschossräumen war sie null, die Position fiel komplett raus, 13,60 €
ohne Spur, kein Rundungs-/Darstellungsfehler. Root-Cause behoben, Karte und
Entwurf liefern für den PM-030-Fall jetzt identische vier Positionen mit
identischen Mengen. Neuer Test `karte-gegen-entwurf.test.ts` hält fest, dass
Karte und Entwurf dieselben Positionen zeigen und die Sockelleiste nie wieder
an einer Normal-Zweig-Größe hängt — künftig fängt der Test einen Rückfall ab,
nicht erst der Prüfmeister von Hand. Die „Karte = Entwurf mit echten
Raummaßen"-Umbauidee bleibt bewusst zurückgestellt (echter Umbau, Raummaße
entstehen erst in der vollen Extraktion), Begründung + Voraussetzung +
Wiedervorlage nach Gate 1 dokumentiert in `pruefmeister-testfaelle.md`. (2)
**Diagonalverlegung bepreist:** hatte seit PM-013 dasselbe Problem wie
PM-025-A — hebt den Verschnitt auf 15 %, wirkte auf keinen Preis, obwohl der
Katalog längst eigene Zeilen dafür führt (Parkett 10,00 €/m², Laminat/Vinyl
8,00 €/m², zunächst übersehen). Jetzt über eine gemeinsame Tabelle
(`MUSTER_KATALOG`) mit Fischgrät vereinheitlicht bepreist; dabei zusätzlich
geprüft und testabgesichert, dass „Aufpreis Diagonalverlegung" (Parkett) und
„Aufpreis Diagonalverlegung Boden" (Fliesen) im Matcher nicht verwechselt
werden und nie gleichzeitig entstehen — genau die Fehlerklasse aus dem
CoS-043-Zuschlagsbug. Testsuite bei diesem Stand: 1.556 Tests grün, `tsc`/
Lint sauber. **Zur Kenntnis, nicht beschönigt:** für Diagonalverlegung
existiert bislang kein einziger Testfall unter den 37 — frisch geänderter,
bislang ungetesteter Code, als Kandidat (analog PM-037) an den Prüfmeister
gegeben. **Governance-Hinweis (Chief of Staff, 06.09.): der Live-Nachtest-
Rückstand wächst spürbar** — offen sind jetzt PM-030, PM-011, PM-012, PM-013,
PM-021, PM-022, PM-025, PM-026, acht Punkte auf einmal. Tempo der Fixes läuft
aktuell schneller als die Live-Verifizierung hinterherkommt; das selbst ist
noch kein Fehler, aber ein Punkt, den Prüfmeister/Sandy im Blick behalten
sollten, bevor die Liste weiter wächst. Quelle: `docs/pruefmeister-testfaelle.md`, `docs/pruefmeister-einsprechliste.md`, `docs/vob-angebot-abstimmung.md` VOB-013/VOB-011/VOB-010, `docs/chief-of-staff-todos.md` CoS-036/CoS-042/CoS-043, `docs/legal-002-risikobewertung-vob.md` LR-14/LR-09, `src/lib/hoerfehler.ts`, Head of Product Engineering direkt an Sandy, 06.09.2026 |
| 1.2 | Abdeckung über beide Gewerke, Raumtypen, Sonderfälle, Verneinungen, Selbstkorrekturen | G1 | 🟢 82 % — **13.09. neu berechnet, 80 → 82 %** — bewusst nur +2: Raumzuordnung/Termin/Kundenname erledigt, aber Manfreds Kernbefund (erfindet und vergisst Positionen) steht. Vorheriger Stand: 🟡 80 % — **02.09., Abend:** der Übermessungshinweis (VOB-004/G5) steht jetzt wirklich live im Kunden-PDF (Fußnote an der Position + Sammelerklärung am Ende, konsistent über beide Renderpfade) — vorher nur code-fertig. Damit ist Legals einziger 🔴-Befund aus der Risikobewertung (LR-01) geschlossen. **05.09.:** VOB-012 (Sockelleisten-Türbreitenabzug) korrigiert Abdeckung über neun Gewerke hinweg, die neue `hoerfehler.ts`-Infrastruktur fängt bekannte Whisper-Verhörer systematisch ab (Sonderfall-/Robustheits-Abdeckung) — beides breiter, aber weiterhin größtenteils ohne breiten Live-Nachtest (VOB-012 erst 9/17 live bestätigt) |
...
| # | Punkt | Gate | Status |
|---|---|---|---|
| 2.1 | Registrierung, Login, Logout laufen sauber durch — komplett | G1 | 🟠 45 % — **⬇️ 13.09. live getestet, 62 → 45 %** (CoS-P-013): Login und Logout sind jetzt erstmals durch Produktions-Logs belegt (`/token` 200, `/logout` 204) — die Registrierung dagegen endet für **jeden** neuen Nutzer auf `/login?error=auth`, obwohl das Konto in Ordnung ist. Onboarding wird übersprungen. Vorheriger Stand: 🟡 62 % — — per Code-Review geprüft (CoS-P-003): strukturell sauber, Account-Enumeration-Schutz, generische Fehlermeldungen. **02.09.: G4 komplett** — eigene Pflicht-Checkbox „Ich melde mich als Unternehmer an (§14 BGB)", getrennt von der AGB-Zustimmung, jetzt im Frontend UND serverseitig bestätigt (Commit `353f5dd`). Live-Nachtest weiterhin aus |
| 2.2 | E-Mail-Verifizierung wirklich zugestellt (nicht nur ausgelöst) | G1 | 🟢 90 % — **⬆️ 13.09. live bestätigt, 55 → 90 %** (CoS-P-013): Sandys echte Registrierung um 20:21 MESZ — Mail kam **sofort, im Posteingang, nicht im Spam**, Absender `sandra@sofortangebot.app`, Konto danach nachweislich bestätigt (`/verify` 303). Die Resend-Strecke aus CoS-P-004 trägt. Nicht auf 100, weil nur ein Anbieter (Gmail) getestet ist. Vorheriger Stand: 🟡 55 % — — **korrigiert, 29.08.:** auf Sandys Freigabe „004 bitte b)" läuft die Verifizierungs-Mail jetzt über die eigene Resend-Anbindung statt Supabase (CoS-P-004, neue Route `api/auth/register`). Code fertig, **echter Zustellungs-Test mit echtem Postfach steht aus** — das kann nur Sandy selbst machen |
| 2.3 | Passwort-Zurücksetzen funktioniert | G1 | 🟢 98 % — **16.09. VOLLSTAENDIG LIVE BESTAETIGT, 15 → 98 %.** Sandy hat den ganzen Weg mit einer echten Adresse durchlaufen: Reset angefordert, Mail kam an, Link eingeloest, neues Passwort gesetzt, **und auf Nachfrage bestaetigt, dass der erneute Login mit dem neuen Passwort funktioniert.** Die Kette ist damit lueckenlos belegt. Nicht 100 %, weil wie bei 2.2 nur ein Mail-Anbieter geprueft ist. CoS-P-013 damit geschlossen. Vorheriger Stand: 🔴 15 % — **⬇️ 13.09. live WIDERLEGT, 60 → 15 %** (CoS-P-013): Der Fix vom 25.08. trägt nicht. Zwei unabhängige Fehler: die Reset-Mail kommt gar nicht erst an (Link wird erzeugt — `/admin/generate_link` 200 —, der Versand danach verschwindet lautlos, ohne Log und ohne Sentry), **und** der Reset-Link liefe über `/auth/callback`, wo schon der Bestätigungslink scheitert. Selbst mit funktionierender Mail wäre der Ablauf kaputt. Nicht 0 %, weil der Link erzeugt wird und die Analyse steht. Vorheriger Stand: 🟡 60 % — — **korrigiert, 29.08.: Bug ist bereits gefixt, nicht mehr offen.** Auf Sandys Freigabe „003 ja bitte direkt reparieren" läuft der Reset-Link jetzt über `/auth/callback` (korrekter PKCE-Tausch, wie bei der Registrierung), plus aktive Session-Prüfung und eine „Link abgelaufen"-Seite statt Endlos-Laden (CoS-P-003). Diese Zeile stand hier fälschlich seit mehreren Tagen auf „weiterhin ungefixt" — eigener Sync-Fehler des Chief of Staff, der Fix war schon am 25.08. dokumentiert. **Einziger verbleibender Schritt: ein echter Klick-Durchlauf mit echtem Postfach**, aus keiner Session heraus möglich — Sandys Aufgabe |
...
| 2.8 | Erster Eindruck für brandneue Nutzer durchdacht (leere Zustände) | G1 | 🟠 45 % — **13.09. neu berechnet, 30 → 45 %** (DC-052/053/054/062/063, Commit `acbdc83`). Vorheriger Stand: 🔴 30 % — DC-009 (leere Aufnahme als Erfolg) jetzt über DC-028 code-seitig mitgefixt, Live-Nachtest steht aus; PM-015-Fix behebt zusätzlich einen konkreten Fall: „manuell"-Onboarding landete bisher mit fast leerer Preisdatenbank |

## 3. Transaktions-E-Mails

| # | Punkt | Gate | Status |
|---|---|---|---|
| 3.1 | Pflicht-Mails werden wirklich versendet (Willkommen, Verifizierung, Reset) | G1 | 🟡 70 % — **16.09., 35 → 70 %: zwei von drei Pflicht-Mails sind live bestaetigt** — Verifizierung (15.09.) und Reset (16.09.). Offen bleibt allein die Willkommens-Mail; sie hing im nie erreichten if(code)-Block, der Weg ist umgebaut, aber niemand hat sie ankommen sehen. Faellt bei Manfreds Session 3 von selbst an. Vorheriger Stand: 🔴 35 % — **⬇️ 13.09. live getestet, 60 → 35 %** (CoS-P-013): **Eine von drei Pflicht-Mails geht raus.** Verifizierung ✅. Reset ❌ (kommt nicht an). Willkommen ❌ — `sendWelcomeEmail()` steht in `auth/callback/route.ts` innerhalb des `if (code)`-Blocks, und dieser Block wird nie erreicht; die Mail, die als die eine sicher funktionierende galt, wird im echten Ablauf nie ausgelöst. Vorheriger Stand: 🟡 60 % — — **korrigiert, 29.08.:** alle drei Pflicht-Mails laufen jetzt über die eigene Resend-Anbindung (CoS-P-004, Sandys Freigabe „004 bitte b)"), nicht mehr nur die Willkommens-Mail. Code fertig, echte Zustellung noch nicht live beobachtet |
| 3.2 | Absender korrekt, Links funktionieren, Inhalt stimmt, landen nicht im Spam | G1 | 🟡 70 % — **⬆️ 13.09. live bestätigt, 55 → 70 %** (CoS-P-013): Absender korrekt, Zustellung in den **Posteingang** (kein Spam), Inhalt und Gültigkeitshinweis stimmen, Zustellung praktisch verzögerungsfrei. Nicht höher, weil „Links funktionieren" nachweislich **nicht** gilt — der Bestätigungslink endet auf einer Fehlerseite — und nur Gmail getestet ist. Vorheriger Stand: 🟡 55 % — — DNS für sofortangebot.app geprüft: DKIM für Resend korrekt gesetzt, SPF deckt Resend nicht direkt ab (über DMARC-Alignment kompensiert), DMARC nur im Beobachtungsmodus (p=none) — Live-Spam-Test steht aus |
...
| 4.7 | Eigene Buchhaltung kann E-Rechnungen empfangen (seit 1.1.2025 Pflicht für alle inländischen Unternehmen, ohne Übergangsfrist für den Empfang) | G1 | 🟡 40 % — **17.09. erstmals bewertet (Head of Finance), 0 → 40 %.** Der Empfangskanal steht, **Verarbeitung und revisionssichere Ablage fehlen.** Drei normgerechte Testrechnungen liegen unter `docs/e-rechnung-empfangstest/` (XRechnung UBL, ZUGFeRD PDF/A-3, CII). Der kleinste Weg zur Erfuellung kostet laut Finance 0 EUR. Bewertung uebernommen, weil sie belegt ist und aus dem eigenen Fachbereich kommt. Vorheriger Stand: ⚪ offen — nicht erhoben (neu). Quelle: [IHK Stuttgart, E-Rechnungspflicht B2B](https://www.ihk.de/stuttgart/fuer-unternehmen/recht-und-steuern/steuerrecht/steuermeldungen/e-rechnungen-5864496) |
...
| # | Punkt | Gate | Status |
|---|---|---|---|
| 5.1 | Man kommt von überall leicht zurück/zur Startseite — keine Sackgassen | G1 | 🔴 35 % — **13.09. erstmals erhoben, 0 → 35 %** — durch Manfreds Durchlauf, nicht durch eine eigene Runde. DC-063/096 und CoS-E-028 gefixt, DC-099 (`BottomNav` hängt an jeder Seite einzeln) offen. Vorheriger Stand: 0 %, nicht erhoben. |
| 5.2 | Jeder Button an sinnvoller Stelle, nichts Wichtiges fehlt/kaputt | G1 | 🟢 82 % — **13.09. neu berechnet, 74 → 82 %** (DC-058/066/071/072/073/079/084, CoS-E-021/024 — gebaut, aber noch nicht committet, siehe 8.7). Vorheriger Stand: 🟡 74 % — **DC-011 behoben + live bestätigt** (fertiges Angebot verschwand aus der Liste). **24.08.: DC-002** (fehlender „Angebote"-Nav-Punkt) behoben. **25.08. (CoS-021/DC-034):** kaputter „ins PDF"-Schalter bei Fotos gefunden und gebaut. **29.08., gebündelter Nachtrag (DC-036/038/039/041):** vier weitere UI-Punkte abgearbeitet — Reiter „Raumform" umbenannt + auffindbar gemacht (DC-036); Grundriss-Zeichner bekam Wandnummern + neue „frei zeichnen"-Funktion (DC-038); „+ Position"-Suche gebaut, dabei ein von Sandy live gefundener Tap-Bug behoben (Vorschlag antippen blieb wirkungslos, jetzt `onMouseDown`+`preventDefault`) (DC-039); Raum-Titelfeld zeigte den literalen Platzhalter „— Schlafzimmer" statt eines leeren Felds, gefixt (DC-041). Alle vier code-fertig/committet, **keines davon live nachgetestet** — deshalb spürbarer, aber kein voller Sprung. **05.09.: PM-010-Kartenzähler-Bug (siehe 1.3) hing auch an dieser Stelle**, ist mitgefixt. Weiterhin offen: DC-009/010 (Erfolgs-Anzeige/Guardrail) |
| 5.3 | Funktioniert auf Handy UND Desktop | G1 | 🟡 35 % — **16.09., 25 → 35 %: DC-101 ist am echten Telefon bestaetigt** (Sandy: Seite geladen, sofort losgetippt, nichts ging verloren). Der Fund, der die Handy-Nutzung am direktesten betraf, ist damit erledigt. Bleibt niedrig, weil die uebrige Handy-Ansicht niemand systematisch durchgegangen ist. Vorheriger Stand: 🔴 25 % — **13.09. erstmals erhoben, 0 → 25 %** — in Desktop- und Handy-Breite getestet, zwei gerätespezifische Befunde gefixt (DC-062, DC-072). Kein echtes Gerät, kein systematischer Durchgang. Vorheriger Stand: 0 %, nicht erhoben. |
...
| 8.4 | Fehler-Monitoring: du merkst, wenn im Betrieb etwas bricht | G2 | 🔴 15 % — **⬇️ 14.09., 20 → 15 % (CoS-P-014):** acht fehlgeschlagene Produktions-Deploys über 17 Stunden, **ohne dass irgendeine Meldung irgendwo aufgeschlagen wäre** — bemerkt wurde es nur, weil zufällig eine Mail nicht ankam. Streng genommen misst dieser Punkt Laufzeitfehler und nicht Builds, deshalb nur ein kleiner Abzug; die Blindheit ist aber dieselbe. Vercel kann Deploy-Fehlschläge mailen (dasselbe Postfach wie die Sentry-Alarme aus 8.9) — Einstellung, kein Bau. Vorheriger Stand: 🔴 20 % — — Health-Checks (`/api/health*`) und Kosten-Alarm existieren und funktionieren, aber Sentry deckt bisher nur den Kernpfad ab |
...
| 8.7 | Verlässliche Kette Code-Fix → Deploy → tatsächlich live | G1 | 🟡 70 % — **✅ 14.09., 14:53 MESZ: gelöst, 35 → 70 %.** Deploy `dpl_ADRqsU5Q…` steht auf **READY** — der erste erfolgreiche Produktions-Deploy seit dem 13.09. um 19:46 UTC. Damit ist die Arbeit von drei Tagen erstmals wirklich live. Nicht höher als 70, weil meine eigene Bedingung von heute Morgen zwei Teile hatte und nur einer erfüllt ist: der Deploy läuft, aber **ein Fehlschlag erreicht weiterhin niemanden**. Dafür ist das Repository jetzt erstmals vollständig — 40 Dateien, die es nirgends außer auf Sandys Platte gab, sind versioniert. *Der Verlauf, der hierher geführt hat:* **⬇️⬇️ 14.09. zunächst auf 35 % zurückgestuft (CoS-P-014).** Der letzte erfolgreiche Produktions-Deploy ist vom **13.09., 19:46 UTC**; die **acht** Deploys danach stehen alle auf `state: ERROR`, weil `src/lib/versandbereit.ts` lokal existiert, aber nie ins Repository committet wurde (`Module not found` in jedem Build). Betroffen: die komplette Designer-Arbeit vom 13.09. **und** der CoS-P-013-Fix vom 14.09., der damit nie gelaufen ist. **Siebzehn Stunden lang hat das niemand gemerkt.** Meine Hochkorrektur auf 65 % am Vorabend („Kette manuell, nicht unterbrochen") war zu dem Zeitpunkt bereits falsch — sie war seit zwei Stunden unterbrochen, ich hatte nur nicht nachgesehen. Zurück nach oben erst, wenn ein Produktions-Deploy wieder READY ist UND ein Fehlschlag jemanden erreicht. Vorheriger Stand: 🟢 80 % (bis 13.09.) → — **⬇️ 13.09. von 80 % auf 65 % zurückgestuft, Korrektur am selben Abend (zuerst stand hier 55 %).** Ursache ist **kein Fehler im Projekt und nichts, was Sandy beheben kann**: ein Windows-Update vom 08.09.2026 hat Claude Cowork auf Windows den Zugriff auf das Laufwerk genommen, bestätigt auf `status.claude.com` („Degraded functionality for Claude Cowork on Windows", 10.09., Microsoft arbeitet am Fix, kein Workaround, Neuinstallation hilft nicht). Dateien lesen und schreiben geht weiter, **Befehle ausführen nicht**. Die Kette ist dadurch **nicht unterbrochen, sondern manuell**: Sandys eigenes Terminal funktioniert normal, sie hat am 13.09. selbst `testlauf.txt`, `probe.txt` und `abgleich.txt` erzeugt. Abgewertet wird deshalb nur das, was real fehlt — ein Mensch muss die Relaisstelle besetzen, und mehrere fertige Stände (die komplette Designer-Arbeit vom 13.09.) liegen uncommittet. Zurück auf 80 %+, sobald diese Stände committet und deployt sind; der volle Wert braucht zusätzlich den Microsoft-Fix. Vorheriger Stand: 🟢 80 % — **21.08.2026 Abend: CoS-016 geklärt, kein offener Blocker mehr.** War kein System-/Architekturproblem, sondern ein technisches Detail von Head of Product Engineerings Fernzugriff (Git-Lock-Dateien nicht löschbar, nur verschiebbar) — inzwischen selbst gelöst, Sandy hat beide CoS-002-Commits gepusht, `main`/`origin/main` gleichauf. Nicht auf 100 %, weil der anschließende Live-Test zeigte, dass „deployt" allein nicht „korrekt live" garantiert (siehe 1.3) |
...
| # | Punkt | Gate | Status |
|---|---|---|---|
| 9.1 | Landingpage erklärt klar, was das Tool tut und für wen | G1 | 🔴 0 % — **17.09.: Es gibt zwei Seiten, und das ist der Kern des Punktes.** LIVE unter `sofortangebot.app` steht weiterhin eine reine Warteliste (Ueberschrift, ein Satz, E-Mail-Feld) — sie erklaert weder was das Produkt tut noch fuer wen, und erfuellt den Punkt nicht. Der NEUE Entwurf liegt unter der eigenen Adresse `sofortangebot-landingpage-entwurf-einfachanfrages-projects.vercel.app` und tut beides, ist aber **nicht veroeffentlicht und ausser Sandy fuer niemanden aufrufbar** (17.09., 18:40 UTC: die Adresse existiert, liegt aber hinter **Vercel Deployment Protection** — unangemeldete Aufrufe landen auf `vercel.com/login`, und `list_deployments` antwortet **403 Forbidden**, nicht 404. Der Zwischenstand von 17:50 UTC, die Adresse existiere nicht, war ein Fehler des Chief of Staff und ist zurueckgezogen; die Freigabe liegt bei Sandy) und enthaelt vier offene Stopper (MwSt.-Angabe trotz § 19, Knappheits-Zeile ohne Kunden, Beispiel-Behauptung, vier widerspruechliche Gratis-Versprechen). Bleibt auf 0: eine Seite, die nicht live ist, zaehlt nicht, und eine, die falsche Zusagen macht, erst recht nicht. Vorheriger Stand: ⚪ offen — nicht erhoben |
...
| 9.7 | Eigene Marke/CI final festgelegt (Farbe, Typografie, Logo, Icon-Sprache) | G2 | 🟡 48 % — Richtung von Sandy final bestätigt („ok leg die CI fest", CoS-M-001), Referenz-Guide fertig (`docs/ci-guide.html`). **31.08.: finaler Slogan „Aufmaß fertig. Angebot fertig." entschieden** — eine weitere offene Teilentscheidung geschlossen. **Korrektur, 05.09. (Chief of Staff):** dieser Zeile stand bisher „Token-Aufräumung DC-006 in Arbeit" — laut `design-check.md` ist DC-006 tatsächlich bereits am 02.09.2026 vollständig abgeschlossen (78 Dateien geprüft, 62 migriert, 16 bewusst ausgenommen, Commit `3e2c778`), die Formulierung hier war stehengeblieben. Umsetzung im Produkt-Code damit weiter als zuvor dargestellt, aber weiterhin nicht fertig: Farbe/Typografie/Mono-Zahlen/Icon-Set/Logomark-Vektorisierung stehen laut Marketing-Agent-Bericht unverändert offen |
...
| # | Punkt | Gate | Status |
|---|---|---|---|
| 11.1 | Kleinunternehmergrenze (25.000 €) im Blick, steuerliche Anmeldung abgeschlossen | G2 | 🔴 20 % — Sandy hat bestätigt: noch kein Gewerbe für Sofortangebot separat angemeldet, Plan ist Kleingewerbe/Kleinunternehmerin nach §19 UStG (CoS-F-001). Entscheidung steht, Anmeldung selbst noch offen. Hängt weiterhin mit 7.1 zusammen (USt-ID). **Bestätigt, 05.09.:** drei unabhängige Legal-Quellen nennen übereinstimmend die Woche vom 05.10. (KW 41) als Zieltermin — siehe Korrektur bei 11.3 |
| 11.2 | Separate EÜR für Sofortangebot-Einnahmen | G2 | ⚪ offen — Sandys Bereich |
| 11.3 | Gewerbeanmeldung | — | 🔴 **Korrektur, 05.09. (Chief of Staff):** diese Zeile stand fälschlich auf „✅ erledigt" — im direkten Widerspruch zu Zeile 11.1 und zu drei unabhängigen Legal-Quellen (`chief-of-staff-legal-todos.md` CoS-L-003, `legal-007-plan-fuer-sandy.md`, `legal-notiz-fuer-chief-of-staff.md`), die übereinstimmend die Anmeldung für die **Woche vom 05.10. (KW 41)** als geplant, noch nicht erfolgt, beschreiben. Die „✅"-Eintragung war ein stehengebliebener Fehler, nicht neu geprüft. Korrigiert auf: offen, geplant KW 41 |
| 11.4 | Geschäftskonto getrennt von privat | G1 | 🔴 0 % — **16.09. erstmals erhoben (vorher nur nicht bewertet): Sandy hat auf direkte Frage geantwortet, es gibt noch kein getrenntes Geschaeftskonto.** Der Punkt bleibt bewusst auf 0 — erhoben ist nicht erledigt, und ein Konto, das es nicht gibt, verdient keine Teilpunkte. Neu ist die **Abhaengigkeit**: Ein Konto laesst sich sinnvoll erst mit der Gewerbeanmeldung eroeffnen, geplant **KW 41 (Woche 05.10.)** — derselbe Termin wie 11.1 und 11.3. An Head of Finance gegeben: ist die Trennung vor Gate 1 ueberhaupt noetig, und was ist der kleinste Weg dorthin. Vorheriger Stand: ⚪ offen — nicht erhoben, Sandys Bereich (neu) |
