...
### PM-033 — Nachtest (Sandy, 2026-09-04): zwei von drei Befunden behoben

Angebot **1.799,04 € netto**.

**Befund 2 und 3 sind erledigt:**

- **Zwei Übergangsschienen** statt einer, 30,00 €. Die Zählung liest jetzt „an
  den beiden Türen … jeweils eine" richtig.
- **Keine Sockelleisten-Position**, in keinem Raum. Der Ausschluss „Sockelleisten
  bleiben überall, wie sie sind" wird respektiert.
- Verschnittsätze unverändert exakt: 31,05 / 14,40 / 7,88 m².

**Das bestätigt die Vermutung aus PM-036 von heute Morgen:** Der Ausschluss-Fix
greift bei der **pauschalen** Formulierung („bleiben überall") und versagt bei
der **raumgebundenen** („im Wohnzimmer bleiben sie"). Zwei Fälle, dieselbe
Leistung, gegenläufiges Ergebnis — das grenzt die Codestelle enger ein als jede
weitere Vermutung von mir.

---

**Befund 1 unverändert — und die Annahme dahinter stimmt nicht**

Die Trittschalldämmung steht wieder im **Wohnzimmer**, mit 27,00 m², und im Flur
fehlt sie. Zahl für Zahl identisch zum 02.09.

Im Fix-Update vom 03.09. steht als Erwartung: *„PM-033, Trittschall-Kurzform —
‚Trittschall nur unterm Laminat im Flur' löst weiterhin nichts aus, weil der
Auslöser das ganze Wort ‚Trittschalldämmung' verlangt."*

**Das ist widerlegt. Sie löst sehr wohl aus** — sie landet nur ohne Raumbezug
beim ersten Raum. Damit ist „soll die Kurzform auslösen?" nicht der offene
Punkt, sondern eine Ablenkung: Der Auslöser funktioniert, die **Raumzuordnung**
nicht. Derselbe Kern wie bei PM-034 (Leistung für zwei Räume fällt aus) und
PM-036 (Ausschluss für einen Raum wird übergangen): *ein Satz, der einen Raum
nennt, wird nicht dem genannten Raum zugeordnet.*

**Fachlich ist die Position doppelt falsch:** Im Wohnzimmer liegt
**Fischgrät-Parkett**, und Fischgrät wird vollflächig verklebt — anders bekommt
man das Muster nicht stabil. Unter einem verklebten Boden liegt keine
Trittschalldämmung, das ist bauphysikalisch nicht vorgesehen. Die 121,50 € sind
also nicht bloß im falschen Raum, sie sind eine Leistung, die es dort gar nicht
geben kann. Im Flur, wo Laminat schwimmend liegt, fehlen dafür 7,50 m² =
33,75 €.

**Antwort auf die offene Frage, damit sie beantwortet ist:**

1. **Ja, die Kurzform muss auslösen.** „Trittschall" ist das Wort, das auf dem
   Bau benutzt wird; „Trittschalldämmung" sagt kaum jemand aus.
2. **Nein, nicht bei jedem Belag.** Schwimmend verlegt (Laminat, Klick-Vinyl,
   Fertigparkett schwimmend) — ja. **Vollflächig verklebt (Fischgrät, Stäbchen,
   Massivparkett auf Estrich) — nein.** Teppichboden — nein, der dämmt selbst;
   dort gibt es allenfalls eine Dämmunterlage, und die heißt auch so.
3. **Und in dem Raum, der genannt wurde.** Steht ein Raum im Satz, gilt der.
   Steht keiner drin, gilt Punkt 2 für jeden Raum einzeln.

**Nebenbei, Familie PD-004:** Die Aufnahme-Karte zeigt für das Wohnzimmer
**1 Position**, der Entwurf enthält **2**. Die Dämmung entsteht erst nach der
Karte, in der Vollständigkeitsprüfung. Für den Nutzer heißt das: Was er vor dem
Erstellen prüft, ist nicht das, was er danach bekommt.

**Status PM-033:** 🟡 Zwei von drei Befunden behoben. Offen bleibt die
Trittschalldämmung — falscher Raum, falscher Belag, und im richtigen Raum fehlt
sie.

---

### PM-035 — Nachtest (Sandy, 2026-09-04): drei von vier Befunden behoben, die L-Form sitzt

Angebot **2.125,54 € netto**.

**Befund 1 — die L-Form ist gelöst, und zwar vollständig.**

| | Soll | Ist |
|---|---|---|
| Flurfläche | 9,60 m² | **9,60 m²** ✅ |
| Parkett Flur | 10,08 m² | **10,08 m²** ✅ |
| Umfang für Sockelleisten | 18,40 lfm | **18,40 lfdm** ✅ |

Beide Schenkel sind drin, und der Umfang stimmt bis auf die Nachkommastelle mit
dem überein, was ich am 02.09. von Hand gerechnet hatte. Das war der Punkt, von
dem es hieß, er brauche ein eigenes Stück Arbeit am Datenmodell — er ist
erledigt.

**Die Warnung dazu ist die beste, die das Produkt bisher hat:** „Flur: L-Form
aus 6,00 × 1,20 m und 2,00 × 1,20 m gerechnet — 9,60 m² Fläche, 18,40 m Umfang
für die Sockelleisten. Stimmt die Form nicht, bitte über ‚Unförmig? Form
zeichnen' korrigieren." Sie zeigt die Zerlegung, beide Ergebniswerte und den Weg
zur Korrektur. Ein Handwerker kann das in fünf Sekunden gegenprüfen.

**Befund 2 — „sechs Meter mal eins zwanzig" ist behoben.** Die Breite kommt
als 1,20 m an, nicht mehr als 1 m. Damit ist auch die „Meter-in-der-Mitte"-Spur
vom 02.09. abgeschlossen.

**Befund 3 — Sockelleisten stimmen.** 18,40 lfdm: richtiger Umfang **und** kein
Türabzug mehr, obwohl drei Türen genannt sind. VOB-012 wirkt, die Türanzahl wird
gelesen. Wohnzimmer und Arbeitszimmer bleiben ohne Sockelleisten — der
Ausschluss „in den Zimmern bleiben die alten" hält.

Auch weiterhin korrekt: „Das Arbeitszimmer hat vierzehn Quadratmeter" steht als
**Boden-/Deckenfläche 14 m²**, der Flur ebenso mit 9,6 m². Karte und Entwurf
zeigen beide 5 Positionen.

---

**Befund 4 offen — „überall" gilt für den Belag, aber nicht für die Dämmung**

Gesagt: „Überall Landhausdiele, gerade verlegt. **Trittschalldämmung überall
drunter.**" Der Belag landet korrekt in allen drei Räumen. Die Dämmung steht
**nur im Flur**, mit 9,60 m².

- **Dasselbe Wort, derselbe Absatz, zwei Ergebnisse.** Das ist der schärfste
  Beleg bisher, dass es nicht am Wortschatz liegt, sondern an der Zuordnung:
  Der Belag wird über alle Räume verteilt, die Dämmung wird **einem** Raum
  zugeschlagen — hier dem zuletzt genannten (Flur), bei PM-033 dem zuerst
  genannten (Wohnzimmer).
- **Fehlbetrag:** 21,32 + 14,00 = 35,32 m² × 4,50 € = **158,94 €**, die der
  Betrieb verlegt und nicht berechnet. Fachlich gehört sie in alle drei Räume:
  Landhausdiele wird schwimmend verlegt.
- Damit steht der Trittschall-Befund jetzt in **vier** Ausprägungen:
  fehlt in zwei von drei Räumen (PM-032, behoben), falscher Raum trotz Ansage
  (PM-033), fehlt in zwei von drei Räumen (PM-035, früher), und jetzt: „überall"
  wird nicht als „alle Räume" gelesen.

**Der gemeinsame Nenner über alle vier offenen Punkte des Batches** — PM-033
Dämmung, PM-034 Sockelleisten für zwei Räume, PM-036 raumgebundener Ausschluss,
PM-035 „überall" — ist derselbe: **Die Zuordnung einer Leistung zu Räumen kennt
nur „genau ein Raum".** Sie kann nicht „alle", nicht „diese zwei" und nicht
„alle außer diesem". Wer das an einer Stelle sauber löst, schließt vermutlich
alle vier.

**Status PM-035:** 🟡 Drei von vier Befunden behoben, darunter der schwerste.
Offen bleibt die Dämmung.

---

## Stufe 1 des Nachtestplans ist durch (Prüfmeister, 2026-09-04)

Fünf Fälle, ein Tag. Von **fünfzehn Befunden sind elf behoben**, und die
Angebotssummen sind dort, wo sie hingehören: PM-034 von 91.085 € auf 1.084 €,
PM-036 von 1.506 € auf 788 €.

| Fall | Stand |
|---|---|
| PM-032 | ✅ bis auf die Sockelleistenzahl bestätigt, 44,00 lfdm noch offen |
| PM-033 | 🟡 Schienen + Sockelleisten behoben · Dämmung offen |
| PM-034 | 🟡 vier von fünf behoben · Sockelleisten für zwei Räume fallen aus |
| PM-035 | 🟡 drei von vier behoben, L-Form gelöst · Dämmung offen |
| PM-036 | 🟡 Teilfläche behoben, Blocker belegt · Sockelleisten im ausgeschlossenen Raum |

**Vier offene Befunde, eine Ursache** (siehe oben). Das ist die einzige
Empfehlung, die ich aus Stufe 1 mitgebe: nicht vier Einzelreparaturen, sondern
die Raumzuordnung so bauen, dass sie eine **Menge von Räumen** kennt — alle,
mehrere, alle außer. Genau das war schon beim Umbau am 03.09. die richtige
Entscheidung, nur eine Ebene zu früh angesetzt.

---

### PM-034 und PM-036 — zweiter Nachtest (Sandy, 2026-09-04, 18:47/18:51): beide grün

**PM-034 ist vollständig grün. Alle fünf ursprünglichen Befunde plus der
Rückfall vom Nachmittag sind behoben.** Angebot **1.026,54 € netto** — der Fall
startete am 02.09. mit 91.085,10 €.

| Raum | Position | Ist | Soll |
|---|---|---|---|
| Küche | Klick-Vinyl inkl. 5 % | 11,34 m² | ✅ |
| Küche | Altbelag entfernen | 10,80 m² | ✅ |
| Küche | **Sockelleisten montieren** | **13,20 lfdm** | ✅ zurück, und mit dem VOB-012-Wert |
| Küche | Untergrundvorbereitung / Ausgleich | 10,80 m² | ✅ nur hier |
| Küche | Trittschalldämmung (Vorschlag) | 10,80 m² | ✅ |
| Esszimmer | Klick-Vinyl inkl. 5 % | 14,70 m² | ✅ |
| Esszimmer | **Sockelleisten montieren** | **15,00 lfdm** | ✅ |
| Esszimmer | Estrich grundieren (Vorschlag) | 14,00 m² | ✅ |
| Esszimmer | Trittschalldämmung (Vorschlag) | 14,00 m² | ✅ |

Sockelleisten zusammen **28,20 lfdm** — exakt das Soll. Damit ist der Rückfall
„Leistung für zwei Räume in einem Satz fällt aus" erledigt: **„Sockelleisten in
Küche und Esszimmer neu" landet jetzt in beiden Räumen.**

Weiter bestätigt: Maße 3,60 × 3,00 und 4,00 × 3,50, kein Flur als Raum, keine
Wandspachtel-Positionen, Karte und Entwurf beide 9 Positionen. Der Altbelag im
Esszimmer ist diesmal mit „Nein, bleibt" beantwortet und entsprechend nicht im
Angebot — der Fall entspricht jetzt sauber dem Soll.

**Zwei Nebenfunde von heute sind mitbehoben:**

- Die Warnung sagt jetzt „bitte **unten auf der Raumkarte** korrigieren" statt
  des vagen „hier". Sie verweist auf einen Ort, den es gibt.
- Der Button trägt ohne Warnung „✓ 9 Positionen erkannt · **Entwurf
  erstellen · ca. 20 Sekunden**", mit Warnung „Trotzdem weiter zum Entwurf".
  Damit ist endgültig belegt, dass es nur **einen** Weiter-Weg gibt und der
  Blocker vom 02.09. behoben ist.

---

**PM-036 ist vollständig grün.** Angebot **733,70 € netto** — auf den Euro die
Summe, die ich am 02.09. als Soll gerechnet hatte.

| Raum | Position | Ist |
|---|---|---|
| Wohnzimmer | Fertigparkett, **Teilfläche** | 6,30 m² ✅ |
| Wohnzimmer | Altbelag entfernen | 6,00 m² ✅ |
| Wohnzimmer | Sockelleisten | **keine** ✅ |
| Flur | Fertigparkett | 6,30 m² ✅ |
| Flur | Altbelag entfernen | 6,00 m² ✅ |
| Flur | Sockelleisten montieren | 11,00 lfdm ✅ |

**Der Rückfall vom Nachmittag ist weg:** „Sockelleisten im Flur neu, **im
Wohnzimmer bleiben sie**" wird jetzt korrekt gelesen — der raumgebundene
Ausschluss greift, und die erfundene 10-lfdm-Position ist verschwunden. Keine
Trittschalldämmung, was bei Parkett ohne Nennung im Diktat richtig ist.

---

**Was das für die gemeinsame Ursache bedeutet**

Von den vier offenen Befunden mit derselben Wurzel sind heute Abend **zwei
gefallen**: „diese zwei Räume" (PM-034) und „alle außer diesem" (PM-036). Die
Zuordnung kann jetzt mehr als „genau ein Raum".

**Offen sind damit nur noch die beiden Trittschall-Fälle** — PM-033 („nur unterm
Laminat im Flur" landet im ersten Raum) und PM-035 („überall drunter" landet im
letzten Raum). Beide wurden **vor** diesem Fix eingesprochen (18:15 und früher),
PM-034 und PM-036 danach. **Gut möglich, dass beide inzwischen mitgelöst sind** —
das kostet zwei Diktate und wäre der sauberste Abschluss des Batches.

**Stand Boden-Batch:** PM-034 ✅ · PM-036 ✅ · PM-032 offen nur bei der
Sockelleistenzahl (44,00 lfdm) · PM-033 und PM-035 offen bei der Dämmung.

---

### PM-033 — dritter Durchlauf (Sandy, 2026-09-04, abends): vollständig grün

Angebot **1.711,29 € netto**, jede Position exakt Soll.

| Raum | Position | Ist |
|---|---|---|
| Wohnzimmer | Fertigparkett Fischgrät inkl. 15 % | 31,05 m² ✅ |
| Wohnzimmer | Trittschalldämmung | **keine** ✅ |
| Schlafzimmer | Teppichboden, 0 % Verschnitt | 14,40 m² ✅ |
| Schlafzimmer | Trittschalldämmung | **keine** ✅ |
| Flur | Laminat inkl. 5 % | 7,88 m² ✅ |
| Flur | **Trittschalldämmung** | **7,50 m²** ✅ |
| Allgemein | Übergangsschiene | 2 Stück ✅ |
| überall | Sockelleisten | **keine** ✅ |

**Alle drei Regeln aus meiner Antwort vom Nachmittag sind umgesetzt:**

1. Die **Kurzform** „Trittschall" löst aus — ohne dass jemand
   „Trittschalldämmung" aussprechen muss.
2. Sie löst **belagabhängig** aus: unter dem schwimmenden Laminat ja, unter dem
   verklebten Fischgrät-Parkett nein, unter dem Teppichboden nein.
3. Sie landet **in dem Raum, der genannt wurde** — „nur unterm Laminat im Flur"
   heißt Flur, mit 7,50 m², der Raumfläche ohne Verschnitt.

Die 121,50 €, die im Wohnzimmer für eine bauphysikalisch unmögliche Dämmung
standen, sind weg; die 33,75 €, die im Flur fehlten, sind da. Der Fall ist
damit in allen drei Befunden abgeschlossen.

**Stand Boden-Batch:** PM-033 ✅ · PM-034 ✅ · PM-036 ✅ · offen: PM-032
(Sockelleisten 44,00 lfdm) und PM-035 (Dämmung „überall drunter").

---

### PM-032 — dritter Durchlauf (Sandy, 2026-09-04, abends): Sockelleisten stimmen, dafür ein neuer Fund

**Die VOB-012-Zahl sitzt.** Sockelleisten Flur 14,40 + Wohnzimmer 18,00 + Küche
11,60 = **44,00 lfdm**, exakt das nachgezogene Soll. Trittschalldämmung
weiterhin in allen drei Räumen (7,20 + 20,00 + 8,40 = 35,60 m²), Belag 37,38 m²,
genau eine Übergangsschiene, kein Bad.

**Aber der Belag hat einen anderen Katalogeintrag getroffen als vorgestern.**

| Durchlauf | Positionstitel | Einheitspreis |
|---|---|---|
| 03.09. | „**Klick-Vinyl** verlegen inkl. 5 % Verschnitt" | 16,00 €/m² |
| 04.09. abends | „**Vinyl-Boden** verlegen inkl. 5 % Verschnitt" | **22,00 €/m²** |

Gesagt wurde beide Male dasselbe: „Überall dasselbe **Klick-Vinyl**, gerade
verlegt." Dieselbe Eingabe, zwei verschiedene Preise.

- **Wirkung:** 37,38 m² × 6,00 € = **224,28 €** Unterschied. Das Angebot steht
  bei 1.239,56 € statt bei 1.015,28 €, also **+22 %** allein durch die
  Bezeichnung.
- **Fundort:** `src/lib/boden-normalisierer.ts` Zeile 42 vergibt das Etikett
  „Klick-Vinyl" nur, wenn im Belagtext tatsächlich „klick" **und** „vinyl"
  stehen; sonst greift Zeile 44 mit „Vinyl-Boden". Die Normalisierung ist also
  richtig gebaut — **instabil ist, was die Extraktion in das Belagfeld
  schreibt.** Mal steht dort „Klick-Vinyl", mal nur „Vinyl".
- **Gegenbeleg aus demselben Abend:** PM-034 (18:47) hat mit demselben Wort im
  Diktat korrekt „Klick-Vinyl verlegen · 16,00 €" erzeugt. Es ist also kein
  Regressions-Fix, der alles auf „Vinyl-Boden" zieht, sondern echte Streuung
  zwischen zwei Läufen.
- **Warum das schwerer wiegt als der Betrag:** Ein Handwerker, der denselben
  Auftrag zweimal einspricht — weil er sich verhaspelt hat, weil der Kunde
  etwas ändert — bekommt zwei verschiedene Preise für dieselbe Arbeit. Merkt er
  es nicht, verschickt er den teureren; merkt er es, glaubt er dem Werkzeug
  nicht mehr. Das ist dieselbe Kategorie wie „zwei Zahlen für dieselbe Fläche",
  die Legal bei PM-031 rechtlich eingeordnet hat, nur eine Ebene früher.
- **Klick-Vinyl ist ein eigener Belag**, kein Synonym: Klick-System, schwimmend
  verlegt, im Katalog mit 16,00 € (LVT) bzw. 18,00 € (SPC) geführt. Wer „Klick"
  sagt, meint das und nichts anderes. Der Treffer muss dem Gesagten folgen.

**Status PM-032:** 🟡 Sockelleisten und Dämmung bestätigt, dafür ein neuer,
eigenständiger Befund zur Belagbezeichnung. Der gehört nicht mehr zu diesem
Fall allein — er trifft jeden Bodenauftrag mit Klick-Vinyl.

---

### PM-035 grün, PM-032 im dritten Lauf wieder richtig — und genau das ist das Problem (2026-09-04, spät)

**PM-035 ist vollständig grün.** Angebot **2.284,48 € netto**.

Die Trittschalldämmung steht jetzt in **allen drei Räumen**: Wohnzimmer 21,32 +
Arbeitszimmer 14,00 + Flur 9,60 = **44,92 m²**, exakt das Soll. „Überall
drunter" wird als „alle Räume" gelesen. Dazu unverändert: L-Form 9,60 m²,
Sockelleisten 18,40 lfdm, Arbeitszimmer als reine Flächenangabe, Belag in allen
drei Räumen.

Damit ist der vierte und letzte Befund aus der Familie „Raumzuordnung kennt nur
genau einen Raum" gefallen. Die Zuordnung beherrscht jetzt alle vier Formen:
**ein Raum · zwei Räume · alle Räume · alle außer diesem.**

---

**PM-032 im dritten Lauf: „Klick-Vinyl … 16,00 €", also der richtige Treffer.**
Angebot **1.015,28 €** — auf den Cent die Zahl, die ich heute Abend als
„mit korrektem Katalogtreffer wären es" ausgerechnet hatte. Sockelleisten 44,00
lfdm, Dämmung 35,60 m², eine Übergangsschiene.

**Trotzdem setze ich den Fall nicht auf grün, und der Grund ist wichtiger als
der Fall:**

| Lauf | Positionstitel | Preis | Angebot |
|---|---|---|---|
| 03.09. | Klick-Vinyl verlegen | 16,00 €/m² | 1.000,43 € |
| 04.09. abends | **Vinyl-Boden verlegen** | **22,00 €/m²** | 1.239,56 € |
| 04.09. später | Klick-Vinyl verlegen | 16,00 €/m² | 1.015,28 € |

Dreimal dasselbe Diktat, zweimal richtig, einmal falsch. **Das ist kein Fall,
der grün ist, sondern einer, der zu zwei Dritteln grün ist** — und das ist keine
Kategorie, die es auf einem Angebot geben darf. Ein Drittel der Angebote wäre
22 % zu teuer, und keiner davon sieht falsch aus, wenn man ihn einzeln
betrachtet.

Genau deshalb bleibt der Befund offen und wird nicht als „war wohl ein
Ausrutscher" abgelegt. Was einmal streut, streut wieder.

**Vorschlag zur Prüfmethode, über diesen Fall hinaus:** Wir haben bisher immer
geprüft, ob ein Ergebnis **richtig** ist. Wir haben nie geprüft, ob es
**wiederholbar** ist. Der Belag-Fund und der alte PM-023-Fund
(„situativ, nicht bei jeder Raum-Paarung reproduzierbar") sind dieselbe Klasse:
Fehler, die nur manchmal auftreten und deshalb durch jede Einzelprüfung
rutschen. Vor Gate 1 gehört deshalb eine eigene Runde: **drei identische
Durchläufe je Fall, und verglichen wird nicht gegen das Soll, sondern gegen
sich selbst.** Ich schlage das für die Fälle mit Katalogtreffern und
abgeleiteten Positionen vor — Belag, Dämmung, Zuschläge.

---

## Boden-Batch PM-032 bis PM-036 — Abschluss (Prüfmeister, 2026-09-04)

Drei Tage, fünf Fälle, **fünfzehn Befunde plus zwei Rückfälle**. Stand jetzt:

| Fall | Stand |
|---|---|
| PM-033 | ✅ grün |
| PM-034 | ✅ grün — von 91.085 € auf 1.026,54 € |
| PM-035 | ✅ grün — L-Form gelöst |
| PM-036 | ✅ grün — 733,70 €, exakt die Soll-Summe |
| PM-032 | 🟡 alle Mengen richtig, aber der Belagtreffer streut zwischen den Läufen |

**Was der Batch fachlich gebracht hat**, in einem Satz: Die Mengenrechnung war
von Anfang an solide — gebrochen war die Übersetzung von Sprache in Zahlen und
die Zuordnung einer Leistung zu Räumen. Beides ist jetzt repariert, und zwar
nicht mit fünf Pflastern, sondern an der Wurzel.

**Was offen bleibt:** der Belag-Streuungsfund (PM-032) und die Frage, ob wir
...
### PM-018 — Nachtest (Sandy, 2026-09-04): alle acht Mengen exakt Soll, aber Q3 ist zurückgefallen

**Die Mengen stimmen vollständig**, inklusive der beiden Werte, wegen derer der
Fall überhaupt neu eingesprochen wurde:

| Position | Ist | Soll |
|---|---|---|
| Spachtelarbeiten Wand | 39,00 m² | ✅ (Übermessung greift) |
| Spachtelarbeiten Decke | 14,00 m² | ✅ eigene Fläche |
| Voranstrich / Grundierung Wand | 39,00 m² | ✅ |
| Voranstrich / Grundierung **Decke** | 14,00 m² | ✅ |
| Wandflächen streichen 2x | 39,00 m² | ✅ |
| Deckenfläche streichen 2x | 14,00 m² | ✅ |
| Boden schützen | 14,00 m² | ✅ |
| Sockelleisten abkleben | **15,00 lfdm** | ✅ VOB-012 |

---

**RÜCKFALL — die Spachtelpositionen heißen wieder „Q2", verlangt war „Q3"**

Im Diktat steht ausdrücklich „Qualitätsstufe **Q3**, weil später Streiflicht
draufscheint". Beide Positionen tragen „Spachtelarbeiten **Q2**".

**Das war am 21.08. schon einmal behoben** und ist der ursprüngliche
Hauptbefund dieses Falls. Jetzt ist er wieder da.

**Und diesmal ist er teurer, als er aussieht.** Der Katalog führt beide Stufen
getrennt:

| Katalogeintrag | Preis |
|---|---|
| Spachtelung Q2 | 9,00 €/m² |
| **Spachtelung Q3** | **14,00 €/m²** |

Berechnet werden 53,00 m² × 9,00 € = 477,00 €. Richtig wären 53,00 m² ×
14,00 € = 742,00 €. **265,00 € fehlen dem Betrieb** — und er macht die
Q3-Arbeit trotzdem, denn der Kunde hat Streiflicht und wird es sehen. Q3 ist
zusätzliches Feinspachteln über die gesamte Fläche, nicht nur an den Stößen.
Wer das zum Q2-Preis anbietet, arbeitet einen halben Tag umsonst.

**Fundort und wahrscheinliche Ursache:** `src/lib/vollstaendigkeit/maler-extras.ts`
prüft die Qualitätsstufe an mehreren Stellen unterschiedlich. Zeile 109 sucht
nach `' q3 '` — **mit Leerzeichen auf beiden Seiten**. Im Diktat steht
„Qualitätsstufe Q3**,** weil später…" — nach dem Q3 kommt ein Komma, kein
Leerzeichen, der Vergleich läuft ins Leere. Zeile 202 macht es im selben File
bereits richtig mit `/\bq[1-4]\b/i`, also mit Wortgrenzen.

**Vorschlag:** überall dieselbe Wortgrenzen-Prüfung verwenden. Dann ist es egal,
ob nach dem Q3 ein Komma, ein Punkt oder ein Satzende folgt. Und ein Test mit
genau diesem Satz — „Qualitätsstufe Q3, weil später Streiflicht draufscheint" —
damit der Fall nicht ein drittes Mal zurückkommt.

**Zwei Darstellungsfunde, die zum selben Thema gehören:**

1. **Zwei Positionen heißen identisch „Spachtelarbeiten Q2"**, einmal mit 39,00
   und einmal mit 14,00 m². Auf dem Kundenangebot steht damit zweimal dieselbe
   Zeile mit verschiedenen Mengen, und niemand kann sagen, welche die Wand und
   welche die Decke ist. Die Grundierung macht es zwei Zeilen weiter vor:
   „Voranstrich / Grundierung" und „Voranstrich / Grundierung **Decke**".
2. **Der Untertitel beider Positionen lautet „Wände für einen ebenen Untergrund
   vollflächig spachteln"** — auch bei der Deckenposition. Der Text widerspricht
   der Menge.
3. Beide Spachtelpositionen tragen das Etikett **„Vorschlag"**, obwohl sie
   ausdrücklich verlangt wurden. Ein Vorschlag ist etwas, das wir mitdenken;
   „Wände UND Decke komplett spachteln" ist eine Ansage. Das Etikett gehört weg,
   sonst verliert es überall seine Bedeutung.

**Status PM-018:** 🟡 Alle Mengen exakt Soll, Sockelleisten und Übermessung
bestätigt. Offen: Q3-Rückfall (265,00 €), Benennung der beiden Spachtelzeilen,
falscher Untertitel bei der Decke, falsches Vorschlag-Etikett.

---

## Stufe 2 abgeschlossen (Prüfmeister, 2026-09-04)

| Fall | Stand |
|---|---|
| PM-002 | ✅ grün (Soll um die Phantom-Decke korrigiert) |
| PM-006 | ✅ Mengen grün · Fund: doppelter Wandpreis 9,50/11,50 |
| PM-010 | ✅ grün · Fund: Karten-Zähler 5/4/6 |
| PM-018 | 🟡 Mengen grün · **Q3-Rückfall** |

**Alle vier zurückgezogenen Haken sind in den Mengen wieder belegt** — die
VOB-Übermessung und VOB-012 stimmen jetzt an jeder geprüften Stelle.

**Was aus Stufe 1 und 2 zusammen offen bleibt**, drei Punkte, alle vom selben
Typ „richtige Menge, falscher Katalogtreffer oder falsche Bezeichnung":

1. **PM-032** — Belagtreffer streut zwischen Klick-Vinyl (16 €) und Vinyl-Boden (22 €)
2. **PM-006/PM-028** — zwei Katalogeinträge für denselben Wandanstrich, 9,50 gegen 11,50 €
3. **PM-018** — Q3 wird als Q2 geführt, 9,00 statt 14,00 €

Die Mengenrechnung ist damit durch. **Was jetzt noch Geld bewegt, ist
...
### PM-032, vierter Lauf (2026-09-04): wieder richtig — und trotzdem noch nicht grün

Alles exakt: Klick-Vinyl **16,00 €/m²** in allen drei Räumen, Belag 37,38 m²,
Sockelleisten 44,00 lfdm, Dämmung 35,60 m², eine Übergangsschiene.
**1.015,28 € netto**, dieselbe Summe wie im dritten Lauf.

**Ich habe vor dem Bewerten im Code nachgesehen: Der Belag-Fix ist nicht
gebaut.** `boden-normalisierer.ts` Zeile 42 ist unverändert, einen Rückfall auf
das Rohtranskript gibt es nicht. Am Verhalten hat sich also nichts geändert —
nur der Würfel ist diesmal wieder richtig gefallen.

**Was der Lauf trotzdem gebracht hat: eine Quote.** Vier Durchläufe, drei mit
16,00 €, einer mit 22,00 €. Rund **25 % Ausfallrate** bei identischem Diktat und
unverändertem Code. Das ist kein Verdacht mehr, das ist eine Messung — und für
den Engineer die brauchbarere Information als jeder weitere grüne Lauf.

**Der Fall bleibt 🟡, unverändert aus demselben Grund:** Nicht weil das Ergebnis
falsch wäre, sondern weil es nicht vorhersagbar ist. Bei einer Ausfallrate von
einem Viertel ist jeder einzelne richtige Lauf zu erwarten und beweist nichts.

---

## ⚠️ Der einzige offene Punkt aus Stufe 1 und 2 — an Head of Product Engineering

Damit er nicht zwischen den erledigten Sachen untergeht, hier noch einmal
allein und ganz am Ende der Datei:

**Belagbezeichnung streut — `boden-normalisierer.ts`, Zeile 42**

- **Symptom:** Dasselbe Diktat („Überall dasselbe Klick-Vinyl") erzeugt mal
  „Klick-Vinyl verlegen · 16,00 €/m²", mal „Vinyl-Boden verlegen · 22,00 €/m²".
  Gemessen über vier Läufe: **einer von vieren** geht daneben, das Angebot ist
  dann 22 % zu teuer.
- **Ursache:** Nicht die Normalisierung — die vergibt das Etikett korrekt,
  sobald „klick" und „vinyl" im Belagfeld stehen. Instabil ist, was die
  Extraktion in dieses Feld schreibt.
- **Fix-Vorschlag:** Gibt das Belagfeld nur „vinyl" her, im **Rohtranskript**
  nachsehen. Steht dort „Klick-Vinyl", „Klickvinyl" oder „Klick", gilt das.
  Ansage vor Struktur.
- **Zwei Tests dazu:** Belagfeld `'vinyl'` + Transkript mit „Klick-Vinyl" →
  Etikett „Klick-Vinyl". Und die Gegenrichtung: Belagfeld `'vinyl'`, kein
  „klick" im Text → bleibt „Vinyl-Boden", damit nicht jeder Designboden zum
  Klick-System wird.
- **Abnahme:** Danach spreche ich PM-032 **einmal** ein. Die vier Kriterien
