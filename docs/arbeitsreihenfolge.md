...
|---|---|---|
| **Engineering** | **PM-090** (Staubschutzwand / Abendreinigung, Zug 2) — von ihnen selbst gesetzt. Danach **CoS-E-074** (die drei DC-116-Teile: Zeit-Ausschluss erkennen, Maße beim Herausnehmen erhalten, Hinweiszeile in `fehlende_angaben`). **Neu vom Prüfmeister, 17.09.:** PM-089-B ist umgestellt und grün (nichts zu tun), der Fehlt-Wortlaut ist bereits getauscht (nichts zu tun), **PM-075 soll in Zug 2 als bepreiste Position** (Anzahl aus dem Satz), und für die **Tapezier-Nische** liegt die Zahl vor (`2 × (Breite + Höhe)`, ohne Höhe nur Fehlt-Eintrag). | niemanden |
| **Prüfmeister** | **Nichts Zugewiesenes offen — alle fünf Punkte am 17.09. vormittags geschlossen** (Heimat: `pruefmeister-restliste.md`, Lauf 17.09.). Marketings beide Fragen beantwortet · Engineerings beide Rückfragen beantwortet, eine davon selbst umgesetzt · PM-097-B umformuliert. Dazu neu geliefert: Zahl für die Tapezier-Nische, Bauauftrag für PM-075. | niemanden |
| **Marketing** | **Textseitig fertig, wartet bewusst.** Vier der sechs Stopper sind textlich zu, Fassung A/B für die Buchhaltungs-Zeile liegt bereit. **Der Prüfmeister-Lauf Büro ist am 17.09. erledigt** — 1.543,80 € bestätigt, PM-098 trägt mit Fenster und Tür im Satz, die Krücke (M-4) kann raus; drei Zeilentitel weichen ab, Entscheidung liegt bei Marketing. | Sandys A/B zu § 19 · Sandys Buchhaltungs-Testlauf (nur A-vs-B) |
